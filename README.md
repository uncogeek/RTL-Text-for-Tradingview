...
#### 🛠️ قابلیت‌های توسعه:
- سیستم قابل توسعه برای اضافه کردن ایموجی‌های بیشتر
- کامنت‌گذاری واضح در کد برای راحتی شخصی‌سازی
- آرایه‌های مجزا برای ایموجی و یونیکد
